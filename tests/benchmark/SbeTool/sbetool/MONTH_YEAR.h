...
#ifndef _SBETOOL_MONTH_YEAR_H_
#define _SBETOOL_MONTH_YEAR_H_
...
public:
    ...
    MONTH_YEAR(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        MONTH_YEAR(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    MONTH_YEAR(
        char *buffer,
        const std::uint64_t bufferLength) :
        MONTH_YEAR(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    MONTH_YEAR &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MONTH_YEAR(buffer, offset, bufferLength, actingVersion);
    }
...
#pragma clang diagnostic pop
    ...
    MONTH_YEAR &year(const std::uint16_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MONTH_YEAR &month(const std::uint8_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MONTH_YEAR &day(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MONTH_YEAR &week(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MONTH_YEAR writer)
{
    builder << '{';
    builder << R"("year": )";
    builder << +writer.year();
