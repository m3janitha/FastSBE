...
#ifndef _SBETEST_TIMEINFORCE_H_
#define _SBETEST_TIMEINFORCE_H_
...
public:
    enum Value
    {
        ...
        IOC = static_cast<std::uint8_t>(2),
        FOK = static_cast<std::uint8_t>(3),
    ...
    static TimeInForce::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            ...
            case static_cast<std::uint8_t>(2): return IOC;
            case static_cast<std::uint8_t>(3): return FOK;
