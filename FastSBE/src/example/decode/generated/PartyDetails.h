...
class PartyDetails
{
    ...
    public:
    	...
    	static constexpr TimeInForce time_in_force_null_value() noexcept
    	{
    		return 0;
    	}
    ...
    public:
    	...
    	constexpr message& set_executor(const char* value) noexcept
    	{
    	...
    	constexpr message& set_executor(std::string_view value) noexcept
    	{
